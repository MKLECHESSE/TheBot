...
try {
    ...
    Write-ErrAndExit "git not found. Install Git for Windows (https://git-scm.com/download/win) and restart terminal."
}
...
$hasChanges = -not [string]::IsNullOrWhiteSpace($statusOut)
